...
export interface ApiAboutUsPageAboutUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    banner_heading: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dual_investment_models_heading: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    our_approach_description: Schema.Attribute.Text & Schema.Attribute.Required;
    our_approach_heading: Schema.Attribute.String & Schema.Attribute.Required;
    our_mission_description: Schema.Attribute.Text;
    our_mission_heading: Schema.Attribute.String;
    our_team_heading: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    the_m_powered_advantage_heading: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    added_by_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    added_by_name: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiClientReviewClientReview
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    review_description: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answer_statement: Schema.Attribute.Text;
    ...
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    question_statement: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageSettingHomePageSetting
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    focus_on_growth_description_text: Schema.Attribute.Text &
      Schema.Attribute.Required;
    ...
    our_services_heading_text: Schema.Attribute.String &
      Schema.Attribute.Required;
    pitch_your_idea_button_link: Schema.Attribute.String;
    pitch_your_idea_button_text: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    request_a_consultation_button_link: Schema.Attribute.String;
    request_a_consultation_button_text: Schema.Attribute.String &
      Schema.Attribute.Required;
    ...
    success_stories_description: Schema.Attribute.Text;
    success_stories_heading: Schema.Attribute.String;
    tech_team_content: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    we_do_not_just_invest_description_text: Schema.Attribute.Text;
    we_do_not_just_invest_heading_text: Schema.Attribute.String;
    what_makes_us_different_description_text: Schema.Attribute.Text;
    what_makes_us_different_heading_text: Schema.Attribute.String;
    what_makes_us_different_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    what_our_client_says_description_text: Schema.Attribute.Text;
    what_our_client_says_heading_text: Schema.Attribute.String;
  };
}
...
export interface ApiInvestmentModelInvestmentModel
  extends Struct.CollectionTypeSchema {
  collectionName: 'investment_models';
  info: {
    displayName: 'Investment Model';
    pluralName: 'investment-models';
    singularName: 'investment-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::investment-model.investment-model'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destination: Schema.Attribute.String;
    github_icon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    social_icon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
